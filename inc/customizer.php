<?php
  function wpb_customize_register($wp_customize){
    ...
    $wp_customize->add_setting('showcase_image_mobile', array(
      'default'   => get_bloginfo('template_directory').'/img/showcase-mobile.jpg',
      'type'      => 'theme_mod'
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'showcase_image_mobile', array(
      'label'   => __('Showcase Image Mobile', 'wpbootstrap'),
      'section' => 'showcase',
      'settings' => 'showcase_image_mobile',
      'priority'  => 1
    )));
    ...
    $wp_customize->add_control('btn_url', array(
      'label'   => __('Button 1 URL', 'wpbootstrap'),
      'section' => 'showcase',
      'priority'  => 4
    ));
    ...
    $wp_customize->add_control('btn_url1', array(
      'label'   => __('Button 2 URL', 'wpbootstrap'),
      'section' => 'showcase',
      'priority'  => 4
    ));
    ...
    $wp_customize->add_control('btn_text', array(
      'label'   => __('Button 1 Text', 'wpbootstrap'),
      'section' => 'showcase',
      'priority'  => 5
    ));
    ...
    $wp_customize->add_control('btn_text1', array(
      'label'   => __('Button 2 Text', 'wpbootstrap'),
      'section' => 'showcase',
      'priority'  => 5
    ));
  }
